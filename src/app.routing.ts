...
const appRoutes:Routes = [
    ...
    {path: 'student', component: StartPageComponent, canActivate: [AuthStudentGuard],},
    {
        ...
        children: [
            ...
            {path: "specialityById", component: SpecialityComponent},
            {path: "facultyById", component: FacultyComponent},
            {path: "group", component: GroupComponent},
            {path: "facultyById/:id/groups", component: GroupsOfFacultyComponent},
