                        ...
                        if (
                            ...
                            this._commonService.getRecordById("subject", this.activeTimeTable[i].subject_id)
                                .subscribe(subject => {
                                    ...
                                    this._subjectService.getTestsBySubjectId("subject",
                                                    ...
                                                    this.entityData.push({
                                                        entityColumns: [
                                                            ...
                                                            this.activeTimeTable[i].start_time
                                                                .substr(0, this.activeTimeTable[i].start_time.length - 3),
                                                            this.activeTimeTable[i].end_date
                                                                .replace(/(\d+)-(\d+)-(\d+)/, '$3-$2-$1') + " / " +
                                                            this.activeTimeTable[i].end_time
                                                                .substr(0, this.activeTimeTable[i].end_time.length - 3),
    ...
    setDate(userDay) {
        ...
        this._commonService.getTime()
            .subscribe(date=> {
                ...
                const secTomorrow = today + secInDate.day;
